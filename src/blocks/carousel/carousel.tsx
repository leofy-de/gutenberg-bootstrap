        ...
        <div className={props.className}>
          ...
          >
            ...
            <div className={cx("carousel-inner")}>
              {
                content.map((slide, key) => <div
                  key={key}
                  className={`gbb-carousel-item ${cx("carousel-item", {active: key === 0})}`}
                >
                  ...
                  <div
                    className={`gbb-carousel-caption ${cx("carousel-caption", "d-none", "d-md-block")}`}>
                    <RichText
                      tagName="h5"
        ...
        >
          {
            content.map((slide, key) => {
              return <div className={`gbb-slide`} key={key}>
                <div

...
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../@types/global */ "./src/@types/global.d.ts");
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_types_global__WEBPACK_IMPORTED_MODULE_1__);
...
var __ = _types_global__WEBPACK_IMPORTED_MODULE_1__["wp"].i18n.__; // Import __() from wp.i18n
var registerBlockType = _types_global__WEBPACK_IMPORTED_MODULE_1__["wp"].blocks.registerBlockType; // Import registerBlockType() from wp.blocks
var _a = _types_global__WEBPACK_IMPORTED_MODULE_1__["wp"].element, Fragment = _a.Fragment, PanelBody = _a.PanelBody, PanelRow = _a.PanelRow;
var _b = _types_global__WEBPACK_IMPORTED_MODULE_1__["wp"].editor, AlignmentToolbar = _b.AlignmentToolbar, BlockControls = _b.BlockControls, RichText = _b.RichText, InspectorControls = _b.InspectorControls;
/**
 * Register: aa Gutenberg Block.
 *
 * Registers a new block provided a unique name and an object defining its
...
registerBlockType('gbb/blockquote', {
    ...
    edit: function (props) {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_3__["createElement"](Fragment, null,
            ...
            react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("div", { className: props.className },
                react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("blockquote", { className: "blockquote " + margin, style: { textAlign: alignment } },
                    react__WEBPACK_IMPORTED_MODULE_3__["createElement"](RichText, { className: "mb-0 blockquote", tagName: "p", onChange: function (quote) {
                            setAttributes({ quote: quote });
                        }, value: quote }),
                    react__WEBPACK_IMPORTED_MODULE_3__["createElement"](RichText, { className: "blockquote-footer", format: "string", tagName: "footer", onChange: function (source) {
    ...
    save: function (props) {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("div", null,
            react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("div", { className: "blockquote " + margin, style: { textAlign: alignment } },
                react__WEBPACK_IMPORTED_MODULE_3__["createElement"](RichText.Content, { className: "mb-0 blockquote", tagName: "p", value: quote }),
                react__WEBPACK_IMPORTED_MODULE_3__["createElement"](RichText.Content, { className: "blockquote-footer", format: "string", tagName: "footer", value: source }))));
    },
});
...
var _b = _types_global__WEBPACK_IMPORTED_MODULE_5__["wp"].editor, AlignmentToolbar = _b.AlignmentToolbar, BlockControls = _b.BlockControls, ColorPalette = _b.ColorPalette, InspectorControls = _b.InspectorControls, RichText = _b.RichText, URLInput = _b.URLInput;
/**
 * Register: aa Gutenberg Block.
 *
 * Registers a new block provided a unique name and an object defining its
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../editor.scss */ "./src/block/editor.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../@types/global */ "./src/@types/global.d.ts");
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_types_global__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _lib_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../lib/icons */ "./src/lib/icons.tsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_4__);
/**
...
var __ = _types_global__WEBPACK_IMPORTED_MODULE_2__["wp"].i18n.__; // Import __() from wp.i18n
var registerBlockType = _types_global__WEBPACK_IMPORTED_MODULE_2__["wp"].blocks.registerBlockType; // Import registerBlockType() from wp.blocks
var Fragment = _types_global__WEBPACK_IMPORTED_MODULE_2__["wp"].element.Fragment;
var _a = _types_global__WEBPACK_IMPORTED_MODULE_2__["wp"].editor, AlignmentToolbar = _a.AlignmentToolbar, BlockControls = _a.BlockControls, InnerBlocks = _a.InnerBlocks, RichText = _a.RichText;
/**
 * Register: aa Gutenberg Block.
 *
 * Registers a new block provided a unique name and an object defining its
...
registerBlockType('gbb/container', {
    ...
    icon: _lib_icons__WEBPACK_IMPORTED_MODULE_3__["default"].container,
    category: 'gbb',
    keywords: [
        __('Bootstrap'),
        __('Container'),
    ...
    edit: function (props) {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: props.className + " my-5", style: { textAlign: alignment } },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"](InnerBlocks, null))));
    },
    /**
     * The save function defines the way in which the different attributes should be combined
     * into the final markup, which is then serialized by Gutenberg into post_content.
    ...
    save: function (props) {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { style: { textAlign: alignment } },
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "container" },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"](InnerBlocks.Content, null))));
    },
});
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_editor_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _lib_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../lib/icons */ "./src/lib/icons.tsx");
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../@types/global */ "./src/@types/global.d.ts");
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_types_global__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_4__);
/**
 * BLOCK: bootstrap-blocks
...
var __ = _types_global__WEBPACK_IMPORTED_MODULE_3__["wp"].i18n.__; // Import __() from wp.i18n
var registerBlockType = _types_global__WEBPACK_IMPORTED_MODULE_3__["wp"].blocks.registerBlockType; // Import registerBlockType() from wp.blocks
var _a = _types_global__WEBPACK_IMPORTED_MODULE_3__["wp"].components, CheckboxControl = _a.CheckboxControl, PanelBody = _a.PanelBody, PanelRow = _a.PanelRow;
var Fragment = _types_global__WEBPACK_IMPORTED_MODULE_3__["wp"].element.Fragment;
var _b = _types_global__WEBPACK_IMPORTED_MODULE_3__["wp"].editor, AlignmentToolbar = _b.AlignmentToolbar, BlockControls = _b.BlockControls, ColorPalette = _b.ColorPalette, InspectorControls = _b.InspectorControls, MediaUpload = _b.MediaUpload, RichText = _b.RichText;
/**
 * Register: aa Gutenberg Block.
 *
 * Registers a new block provided a unique name and an object defining its
...
registerBlockType('gbb/media', {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"](PanelRow, null,
                        ...
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("form", { onSubmit: setMargin },
                            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("select", { value: margin, onChange: setMargin },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("option", { value: "my-5" }, "my-5 - Hugh margin")))))),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"](BlockControls, null,
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"](AlignmentToolbar, { value: alignment, onChange: function (alignment) {
                        setAttributes({ alignment: alignment });
                    } })),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: props.className },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "media " + margin, style: {
                        textAlign: alignment,
                        margin: margin
                    } },
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"](MediaUpload, { buttonProps: {
                            ...
                            var open = _a.open;
                            return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "media-image mr-3", onClick: open }, !imageId ?
                                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "btn btn-secondary" },
                                    _lib_icons__WEBPACK_IMPORTED_MODULE_2__["default"].upload,
                                    " ",
                                    __('Upload image')) :
                                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("img", { src: imageUrl })));
                        } }),
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "media-body" },
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"](RichText, { className: "media-heading mt-0", multiline: "p", tagName: "h5", onChange: function (title) {
                                setAttributes({ title: title });
                            }, value: title }),
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"](RichText, { className: "content", tagName: "div", onChange: function (content) {
    ...
    save: function (props) {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", null,
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "media " + margin, style: { textAlign: alignment } },
                imageId &&
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("img", { src: imageUrl, className: "media-image mr-3" }),
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "media-body" },
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"](RichText.Content, { className: "media-heading", tagName: "h5", value: title }),
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"](RichText.Content, { className: "content", tagName: "div", value: content })))));
    },
});
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../@types/global */ "./src/@types/global.d.ts");
/* harmony import */ var _types_global__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_types_global__WEBPACK_IMPORTED_MODULE_4__);
/**
 * BLOCK: bootstrap-blocks
 *
 * Registering a basic block with Gutenberg.
...
var __ = _types_global__WEBPACK_IMPORTED_MODULE_4__["wp"].i18n.__; // Import __() from wp.i18n
var registerBlockType = _types_global__WEBPACK_IMPORTED_MODULE_4__["wp"].blocks.registerBlockType; // Import registerBlockType() from wp.blocks
var _a = _types_global__WEBPACK_IMPORTED_MODULE_4__["wp"].components, CheckboxControl = _a.CheckboxControl, PanelBody = _a.PanelBody, PanelRow = _a.PanelRow;
var Fragment = _types_global__WEBPACK_IMPORTED_MODULE_4__["wp"].element.Fragment;
var _b = _types_global__WEBPACK_IMPORTED_MODULE_4__["wp"].editor, AlignmentToolbar = _b.AlignmentToolbar, BlockControls = _b.BlockControls, ColorPalette = _b.ColorPalette, InspectorControls = _b.InspectorControls, RichText = _b.RichText;
/**
 * Register: aa Gutenberg Block.
 *
 * Registers a new block provided a unique name and an object defining its
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _block_alert_alert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block/alert/alert */ "./src/block/alert/alert.tsx");
/* harmony import */ var _block_blockquote_blockquote__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block/blockquote/blockquote */ "./src/block/blockquote/blockquote.tsx");
/* harmony import */ var _block_button_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block/button/button */ "./src/block/button/button.tsx");
/* harmony import */ var _block_container_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block/container/container */ "./src/block/container/container.tsx");
/* harmony import */ var _block_media_media__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block/media/media */ "./src/block/media/media.tsx");
/* harmony import */ var _block_type_type__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block/type/type */ "./src/block/type/type.tsx");
/**
 * Gutenberg Blocks
 *
